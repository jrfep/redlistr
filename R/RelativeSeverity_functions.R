...
RelativeSeverityPlot <- function(ecosystem.data,
    ...
    rect(-1*thresholds[5],thresholds[4]/100,-1*thresholds[4],thresholds[5]/100,col="red")
    rect(-1*thresholds[5],thresholds[3]/100,-1*thresholds[4],thresholds[4]/100,col="orange")
    rect(-1*thresholds[5],thresholds[2]/100,-1*thresholds[4],thresholds[3]/100,col="yellow")
    rect(-1*thresholds[4],thresholds[4]/100,-1*thresholds[3],thresholds[5]/100,col="orange")
